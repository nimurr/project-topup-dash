  ...
  return (
    <section className="w-full py-6">
      {settingsItem.map((setting, index) => (
        <div
          key={index}
          className="w-full p-4 mb-2 text-sm rounded-lg bg-[#b0e6e881] hover:bg-transparent hover:border-[#038c6d] border flex items-center justify-between cursor-pointer "
